...
weshopApp.controller('WeshopHomeController', function ($scope, $rootScope, $http, weshopHeaders, weshopContent, weshopService) {
    ...
    $scope.amazonBannerList = weshopService.amzBannerList();
    $scope.ebayBannerList = weshopService.ebayBannerList();
    $scope.dhgateBannerList = weshopService.dhgateBannerList();
    $scope.portalBannerList = weshopService.portalBannerList();
    $scope.recentlyViewProduct = weshopService.recentlyViewProduct();
});
